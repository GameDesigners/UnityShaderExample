Shader "Custom/Mapping/SingleTetxure"
{
    Properties
    {
...
#include "Lighting.cginc"
            ...
            fixed4 frag(v2f i) : SV_Target{
                ...
                fixed3 worldLightDir = normalize(WorldSpaceLightDir(float4(i.worldPos,1)));
                ...
                fixed3 specular = _LightColor0.rgb * _Specular.rgb * pow(saturate(max(0, dot(worldNormal, halfDir))), _Gloss);
